...
#         # Gunakan hanya data angka agar AI lebih cepat menganalisis
#         latest_data = data.tail(30)[["Open", "High", "Low", "Close"]].to_string()

#         messages = [{
#             'role': 'user',
#             'content': f"""Anda adalah seorang Trader Kripto yang mengkhususkan diri dalam Analisis Teknikal.
#                           Berikut adalah 30 data candlestick terakhir dari {ticker}:
#                           {latest_data}
...
#         model_name = "gemma3:4b"  # Bisa coba "gemma:2b" jika lebih ringan
...
if "crypto_data" in st.session_state:
    ...
    if st.button("Jalankan AI Teknikal Analisis"):
        with st.spinner("Menjalankan AI..."):
            ...
            model_name = "gemma3:4b"  # Bisa ganti ke "gemma3:4b" jika ingin model lebih besar
